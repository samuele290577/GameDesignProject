...
public class HumanDatabase: MonoBehaviour
{
    ...
    void Awake()
    {
        cardList.Add(new Arma(0, "Bomb", 10, 25, 12, 5, 45f));
        cardList.Add(new Arma(1, "Dynamite", 2, 15, 18, 25, 45f));
        cardList.Add(new Arma(2, "Molotov", 2, 35, 8, 4, 45f));
        cardList.Add(new Arma(3, "Rifle", 1, 30, 10, 1, 45f));
        cardList.Add(new Arma(4, "Shotgun", 1, 50, 3, 9, 45f));
        cardList.Add(new Arma(5, "Knife", 10, 30, 5, 1, 45f));
