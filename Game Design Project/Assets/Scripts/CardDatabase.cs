...
{ 
    ...
    {
        //PIANTE
        cardDatabase.Add(0, new Arma(0, "Apple", 10, 25, 12, 5));
        cardDatabase.Add(1, new Arma(1, "Banana", 2, 15, 18, 25));
        cardDatabase.Add(2, new Arma(2, "Pinapple", 2, 35, 8, 4));
        cardDatabase.Add(3, new Arma(3, "Coconut", 1, 20, 20, 9));
        cardDatabase.Add(4, new Arma(4, "Watermelon", 1, 20, 18, 4));
        cardDatabase.Add(5, new Arma(5, "Oranges", 10, 30, 5, 1));
        ...
        //UMANI
        cardDatabase.Add(10, new Arma(10, "Bomb", 10, 25, 12, 5));
        cardDatabase.Add(11, new Arma(11, "Dynamite", 2, 15, 18, 25));
        cardDatabase.Add(12, new Arma(12, "Molotov", 2, 35, 8, 4));
        cardDatabase.Add(13, new Arma(13, "Rifle", 1, 30, 10, 1));
        cardDatabase.Add(14, new Arma(14, "Shotgun", 1, 50, 3, 9));
        cardDatabase.Add(15, new Arma(15, "Knife", 10, 30, 5, 1));
